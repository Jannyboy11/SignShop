...
public class UnlinkHandler implements ICommandHandler {
    ...
    private boolean handleUnlinkCommand(Location loc) {
        ...
        Map<Shop, SSDestroyedEventType> affectedSellers = SignShopUtil.getRelatedShopsByBlock(block);

        for (Map.Entry<Shop, SSDestroyedEventType> entry : affectedSellers.entrySet()) {
